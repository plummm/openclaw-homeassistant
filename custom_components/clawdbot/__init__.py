    ...
    <div class=\"card agent-hero\" id=\"agentHeroCard\" style=\"position:relative;overflow:hidden\">
      ...
      <div class=\"row\" style=\"position:relative;z-index:1;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap\">
        <div class=\"row\" style=\"gap:14px;align-items:center\">
          <button type=\"button\" id=\"agentAvatarBtn\" class=\"btn\" style=\"width:128px;height:128px;border-radius:28px;display:flex;align-items:center;justify-content:center;overflow:hidden;background:linear-gradient(135deg, rgba(0,245,255,.25), rgba(123,44,255,.25));border:1px solid color-mix(in srgb, var(--primary-color) 45%, var(--divider-color));font-weight:800;letter-spacing:.5px;font-size:28px;cursor:pointer;position:relative;padding:0\">\n            <img id=\"agentAvatarImg\" alt=\"agent avatar\" style=\"display:none;width:100%;height:100%;object-fit:cover\"/>\n            <div id=\"agentAvatarFallback\" style=\"display:flex;align-items:center;justify-content:center;width:100%;height:100%\">A0</div>\n          </button>\n          <div id=\"avatarGenModal\" class=\"modal hidden\" style=\"position:fixed;inset:0;background:rgba(0,0,0,0.62);display:flex;align-items:center;justify-content:center;z-index:10000;\">\n            <div class=\"modal-card\" style=\"max-width:680px;width:min(680px,92vw);max-height:min(78vh,720px);overflow:auto;background:var(--ha-card-background, var(--card-background-color));border-radius:18px;box-shadow:0 20px 60px rgba(0,0,0,0.35);padding:18px;border:1px solid color-mix(in srgb, var(--divider-color) 70%, transparent);\">\n              <div style=\"display:flex;justify-content:space-between;align-items:center;gap:10px\">\n                <div style=\"font-weight:900\">Describe your agent</div>\n                <button class=\"btn\" id=\"avatarGenClose\">Close</button>\n              </div>\n              <div class=\"muted\" style=\"margin-top:8px\">Describe what your agent looks like. Or hit <b>Surprise me</b> to auto-draft a backstory + appearance.</div>\n              <textarea id=\"avatarGenText\" style=\"margin-top:12px;width:100%;min-height:120px;resize:vertical;border-radius:14px;border:1px solid var(--cb-border-strong);padding:12px;background:color-mix(in srgb, var(--ha-card-background, var(--card-background-color)) 92%, transparent);color:var(--primary-text-color);font-family:inherit\" placeholder=\"e.g., Warm smile, short black hair, futuristic pilot jacket...\"></textarea>\n              <div class=\"row\" style=\"justify-content:flex-end;gap:10px;margin-top:12px;flex-wrap:wrap\">\n                <button class=\"btn\" id=\"avatarGenSurprise\" data-testid=\"avatar-surprise\">Surprise me</button>\n                <button class=\"btn primary\" id=\"avatarGenGenerate\" data-testid=\"avatar-generate\">Generate</button>\n              </div>\n              <div class=\"muted\" id=\"avatarGenHint\" style=\"margin-top:10px;font-size:12px\"></div>\n              <div class=\"muted\" id=\"avatarGenDebug\" style=\"margin-top:8px;font-size:11px;opacity:.85\"></div>\n            </div>\n          </div>
