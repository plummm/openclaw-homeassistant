    ...
    <div class=\"card agent-hero\" id=\"agentHeroCard\" style=\"position:relative;overflow:hidden\">
      ...
      <div class=\"row\" style=\"position:relative;z-index:1;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap\">
        <div class=\"row\" style=\"gap:14px;align-items:center\">
          <button type=\"button\" id=\"agentAvatarBtn\" class=\"btn\" style=\"width:128px;height:128px;border-radius:28px;display:flex;align-items:center;justify-content:center;overflow:hidden;background:linear-gradient(135deg, rgba(0,245,255,.25), rgba(123,44,255,.25));border:1px solid color-mix(in srgb, var(--primary-color) 45%, var(--divider-color));font-weight:800;letter-spacing:.5px;font-size:28px;cursor:pointer;position:relative;padding:0\">\n            <img id=\"agentAvatarImg\" alt=\"agent avatar\" style=\"display:none;width:100%;height:100%;object-fit:cover\"/>\n            <div id=\"agentAvatarFallback\" style=\"display:flex;align-items:center;justify-content:center;width:100%;height:100%\">A0</div>\n          </button>\n          <div id=\"avatarGenModal\" class=\"modal hidden\" style=\"position:fixed;inset:0;background:rgba(0,0,0,0.45);display:flex;align-items:center;justify-content:center;z-index:10000;\">\n            <div class=\"modal-card\" style=\"max-width:720px;width:min(720px,92vw);max-height:min(78vh,720px);overflow:auto;color:#eaf2ff;border-radius:20px;padding:18px;border:1px solid rgba(0,245,255,0.18);box-shadow:0 26px 80px rgba(0,0,0,0.55);background:linear-gradient(135deg, rgba(11,18,32,0.98), rgba(10,8,24,0.98));\">\n              <div style=\"display:flex;justify-content:space-between;align-items:center;gap:12px\">\n                <div style=\"font-weight:950;letter-spacing:-0.02em;font-size:18px\">Describe your agent</div>\n                <button class=\"btn\" id=\"avatarGenClose\" title=\"Close\" style=\"width:38px;height:38px;border-radius:12px;padding:0;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.10);\">✕</button>\n              </div>\n              <div class=\"muted\" style=\"margin-top:8px;line-height:1.35;color:rgba(234,242,255,0.78)\">Describe what your agent looks like. Or hit <b>Surprise me</b> to auto-draft a backstory + appearance.</div>\n              <textarea id=\"avatarGenText\" style=\"margin-top:12px;width:100%;min-height:120px;resize:vertical;border-radius:16px;border:1px solid rgba(0,245,255,0.16);padding:12px 14px;background:linear-gradient(180deg, rgba(15,23,42,0.96), rgba(9,13,26,0.96));color:#eaf2ff;font-family:inherit;outline:none;\" placeholder=\"e.g., Warm smile, short black hair, futuristic pilot jacket...\"></textarea>\n              <div class=\"row\" style=\"justify-content:flex-end;gap:10px;margin-top:12px;flex-wrap:wrap\">\n                <button class=\"btn\" id=\"avatarGenSurprise\" data-testid=\"avatar-surprise\" style=\"height:38px;border-radius:14px;padding:0 14px;background:rgba(255,255,255,0.06);border:1px solid rgba(0,245,255,0.22);color:#eaf2ff;\">Surprise me</button>\n                <button class=\"btn primary\" id=\"avatarGenGenerate\" data-testid=\"avatar-generate\" style=\"height:38px;border-radius:14px;padding:0 16px;border:1px solid rgba(0,245,255,0.35);background:linear-gradient(135deg, rgba(0,245,255,0.92), rgba(123,44,255,0.90));color:#061018;font-weight:900;\">Generate</button>\n              </div>\n              <div class=\"muted\" id=\"avatarGenHint\" style=\"margin-top:10px;font-size:12px;color:rgba(234,242,255,0.72)\"></div>\n              <div class=\"muted\" id=\"avatarGenDebug\" style=\"margin-top:8px;font-size:11px;opacity:.65\"></div>\n            </div>\n          </div>
